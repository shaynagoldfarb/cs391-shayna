...
var_m = term_var("m")
styp_a = "a"
styp_churchnum = f"({styp_a} -> {styp_a}) -> {styp_a} -> {styp_a}"
styp_fun_aa = f"{styp_a} -> {styp_a}"

chnum_mul = term_lam("m", styp_churchnum,
               term_lam("n", styp_churchnum,
                 term_lam("f", styp_fun_aa,
                   term_lam("x", styp_a,
                     term_app(
